    ...
    public class InterpolationParameters
    {
        public static InterpolationParameters CreateDefault()
        {
            return new InterpolationParameters
            {
                ...
                MaxNumberOfRefinementIterations = 3,
                AveragingMethod = 1,
        ...
        /// <summary>
        /// *Refine only faces completely inside the polygon
        /// </summary>
        [ProtoMember(8)]
        public bool RefineIntersected { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether use mass centers while refining.
        /// </summary>
        [ProtoMember(9)]
        public bool UseMassCenters { get; set; }
    }
}
