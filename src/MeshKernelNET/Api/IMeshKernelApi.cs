...
namespace MeshKernelNET.Api
{
    public interface IMeshKernelApi : IDisposable
    {
        ...
        /// </param>
        /// <returns>Error code</returns>
        int ContactsComputeBoundary(int meshKernelId, IntPtr oneDNodeMask, DisposableGeometryList polygons, double searchRadius);
        ...
        /// <param name="oneDNodeMask">The mask to apply to 1d nodes (1 = generate a connection, 0 = do not generate a connection)</param>
        /// <returns>Error code</returns>
        int ContactsComputeMultiple(int meshKernelId, IntPtr oneDNodeMask);
        ...
        /// </param>
        /// <returns>Error code</returns>
        int ContactsComputeSingle(int meshKernelId, IntPtr oneDNodeMask, DisposableGeometryList polygons, double projectionFactor);
        ...
        /// <returns>Error code</returns>
        int ContactsComputeWithPoints(int meshKernelId, IntPtr oneDNodeMask, DisposableGeometryList points);
        ...
        /// <returns>Error code</returns>
        int ContactsComputeWithPolygons(int meshKernelId, IntPtr oneDNodeMask, DisposableGeometryList polygons);
        ...
        /// <returns>Error code</returns>
        int Mesh2dSnapToLandBoundary(int meshKernelId, DisposableGeometryList selectingPolygon, DisposableGeometryList landBoundaries);
        ...
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="direction">The direction which to compute the smoothness</param>
        /// <param name="curvature">The grid curvature values the selected direction</param>
        /// <returns>Error code</returns>
        ...
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="direction">The direction which to compute the smoothness</param>
        /// <param name="smoothness">The grid smoothness values the selected direction</param>
        /// <returns>Error code</returns>
        int CurvilinearComputeSmoothness(int meshKernelId, CurvilinearDirectionOptions direction, ref double[] smoothness);

        /// <summary>
        /// Computes a curvilinear mesh a polygon. 3 separate polygon nodes need to be selected.
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="geometryList">The input polygon</param>
        ...
        /// <returns>Error code</returns>
        int CurvilinearComputeTransfiniteFromPolygon(int meshKernelId, DisposableGeometryList geometryList,
                                                     int firstNode, int secondNode, int thirdNode, bool useFourthSide);

        /// <summary>
        /// Computes a curvilinear mesh a triangle. 3 separate polygon nodes need to be selected. The MeshKernel
        /// implementation differs from the polygon case.
        /// For this reason a different api had to be made.
        /// </summary>
        /// <param name="meshKernelId">Id of the mesh state</param>
        /// <param name="geometryList">The input polygons</param>
        /// <param name="firstNode">The first selected node</param>
        /// <param name="secondNode">The second selected node</param>
        /// <param name="thirdNode"> The third node</param>
        /// <returns>Error code</returns>
        int CurvilinearComputeTransfiniteFromTriangle(int meshKernelId,
                                                      DisposableGeometryList geometryList,
                                                      int firstNode,
                                                      int secondNode,
                                                      int thirdNode);
        ...
        /// <summary>
        /// Delete the exterior part of a rectangle the curvilinear grid
        /// </summary>
        /// <param name="meshKernelId">Id of the mesh state</param>
        ...
        /// <summary>
        /// Delete the interior part of a rectangle the curvilinear grid
        /// </summary>
        /// <param name="meshKernelId">Id of the mesh state</param>
        /// <param name="boundingBox">The bounding box defining the rectangle</param>
        /// <returns>Error code</returns>
        ...
        int CurvilinearFinalizeLineShift(int meshKernelId);
         ...
         /// </summary>
         /// <param name="meshKernelId">Id of the grid state</param>
         /// <param name="disposableCurvilinearGrid">The disposable curvilinear grid</param>
         /// <returns>Error code</returns>
        ...
        int CurvilinearInitializeOrthogonalGridFromSplines(int meshKernelId,
                                                           DisposableGeometryList geometryListNative,
                                                           CurvilinearParameters curvilinearParametersNative,
                                                           SplinesToCurvilinearParameters splinesToCurvilinearParameters);
        ...
        /// <summary>
        /// One advancement of the front curvilinear grid from splines (interactive)
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        ...
        /// <summary>
        /// Attracts/repulses grid lines a block towards another set grid line
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        ...
        /// @brief Computes the new grid, shifting the line towards the moved nodes and distributing the shifting block specified before
        /// <param name="meshKernelId">The id of the mesh state</param>
        /// <returns>Error code</returns>
        ...
        /// <returns>Error code</returns>
        int CurvilinearComputeRectangularGrid(int meshKernelId, MakeGridParameters makeGridParameters);
        ...
        /// <returns>Error code</returns>
        int CurvilinearComputeRectangularGridOnExtension(int meshKernelId, MakeGridParameters makeGridParametersNative);
        ...
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state </param>
        /// <param name="orthogonalizationParameters">The orthogonalization parameters to use the algorithm</param>
        ...
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state </param>
        /// <param name="mRefinement">The amount of refinement (positive) o de-refinement (negative) to compute m-direction</param>
        /// <param name="nRefinement">The amount of refinement (positive) o de-refinement (negative) to compute n-direction</param>
        /// <returns>Error code</returns>
        ...
        /// <returns>Error code</returns>
        int CurvilinearSet(int meshKernelId, DisposableCurvilinearGrid grid);
        ...
        /// <summary>
        /// Adds a frozen the meshkernel state. A frozen line is stored as a pair of coordinates.
        ...
        /// <summary>
        /// Deletes a frozen line the meshkernel state
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        ...
        /// <summary>
        /// Gets the number of stored frozen lines the state
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        /// <param name="numFrozenLines">The number of stored frozen lines the state</param>
        /// <returns>Error code</returns>
        ...
        /// <summary>
        /// Snaps a curvilinear grid line to spline
        /// </summary>
        /// <param name="meshKernelId">The ID of the mesh state</param>
        ...
        /// <returns>Error code</returns>
        int GetSplines(DisposableGeometryList disposableGeometryListIn,
        ...
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        /// <param name="disposableMesh1D">The mesh1d of the block to orthogonalize</param>
        /// <returns>Error code</returns>
        ...
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        /// <param name="disposableMesh1D">The mesh1d</param>
        /// <returns>Error code</returns>
        int Mesh1dSet(int meshKernelId, DisposableMesh1D disposableMesh1D);
        ...
        /// <param name="orthogonalizationParameters">The structure containing the orthogonalization parameters </param>
        /// <param name="geometryListPolygon">The polygon where to perform the orthogonalization </param>
        /// <param name="geometryListLandBoundaries">The land boundaries to account for the orthogonalization process </param>
        /// <returns>Error code</returns>
        int Mesh2dComputeOrthogonalization(int meshKernelId,
                                           ProjectToLandBoundaryOptions projectToLandBoundaryOption,
                                           OrthogonalizationParameters orthogonalizationParameters,
                                           DisposableGeometryList geometryListPolygon,
                                           DisposableGeometryList geometryListLandBoundaries);
        ...
        /// <returns>Error code</returns>
        int Mesh2dMergeMeshes(int meshKernelId, DisposableMesh2D disposableMesh2D);
        ...
        /// <returns>Error code</returns>
        int Mesh2dMergeAndConnectMeshes(int meshKernelId, DisposableMesh2D disposableMesh2D, DisposableGeometryList geometryListPolygon, double searchFraction);
        ...
        /// <summary>
        /// Count the number of hanging edges a mesh2d.
        /// </summary>
        /// <param name="meshKernelId">The id of the mesh state</param>
        ...
        /// <summary>
        /// Counts the number of polygon vertices contained the mesh boundary polygon
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="selectingPolygon">The input polygon for generating boundary polygon selected areas</param>
        /// <param name="numberOfPolygonVertices">The number of polygon points</param>
        /// <returns>Error code</returns>
        int Mesh2dCountMeshBoundariesAsPolygons(int meshKernelId, DisposableGeometryList selectingPolygon, ref int numberOfPolygonVertices);
        ...
        /// <summary>
        /// Deletes a mesh a polygon using several options
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        ...
        int Mesh2dDelete(int meshKernelId,
                         DisposableGeometryList disposableGeometryListOut,
        ...
        /// The land boundaries to account for when flipping the edges(num_coordinates = 0 for no land boundaries)</param>
        /// <returns>Error code</returns>
        ...
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="disposableMesh2D"><see cref="DisposableMesh2D"/> with the grid state</param>
        /// <returns>Error code</returns>
        ...
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="selectingPolygon">The input polygon for generating boundary polygon selected areas</param>
        /// <param name="disposableGeometryList">The output network boundary polygon</param>
        /// <returns>Error code</returns>
        int Mesh2dGetMeshBoundariesAsPolygons(int meshKernelId, DisposableGeometryList selectingPolygon, ref DisposableGeometryList disposableGeometryList);
        ...
        /// <param name="selectedVertices">The selected vertices</param>
        /// <returns>Error code</returns>
        int GetSelectedVerticesInPolygon(int meshKernelId, DisposableGeometryList disposableGeometryListIn,
        ...
        /// <summary>
        /// Counts the number of polygon nodes contained the mesh boundary polygons computed function
        ...
        /// <param name="geometryListNativeLandBoundaries">The land boundaries to account for the orthogonalization process</param>
        /// <returns>Error code</returns>
        ...
        /// <param name="meshKernelId">The id of the mesh state</param>
        /// <param name="firstNodeX">The index of the first node to connect</param>
        /// <param name="firstNodeY">The index of the second node to connect</param>
        /// <param name="secondNodeX">The index of the first node to connect</param>
        /// <param name="secondNodeY">The index of the second node to connect</param>
        /// <param name="firstNodeIndex">The index of the first node</param>
        /// <param name="secondNodeIndex">The index of the second node</param>
        /// <param name="edgeIndex">The index of the new generated edge</param>
        /// <returns>Error code</returns>
        ...
        int Mesh2dIntersectionsFromPolygon(int meshKernelId,
                                           DisposableGeometryList boundaryPolygon,
                                           ref int[] edgeNodes,
                                           ref int[] edgeIndex,
        ...
        /// <summary>
        /// Make a triangular grid a polygon
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="disposableGeometryList">The polygon where to triangulate</param>
        /// <param name="scaleFactor">Scale factor (-999.0 = an internal scaling factor will be computed)</param>
        /// <returns>Error code</returns>
        int Mesh2dMakeTriangularMeshFromPolygon(int meshKernelId, DisposableGeometryList disposableGeometryList, double scaleFactor);
        ...
        /// <returns>Error code</returns>
        int Mesh2dMakeTriangularMeshFromSamples(int meshKernelId, DisposableGeometryList disposableGeometryList);
        ...
        /// <param name="makeGridParameters">The structure containing the make grid parameters</param>
        /// <returns>Error code</returns>
        int Mesh2dMakeRectangularMeshOnExtension(int meshKernelId, MakeGridParameters makeGridParameters);
        ...
        /// <returns>Error code</returns>
        int Mesh2dMergeNodes(int meshKernelId, DisposableGeometryList disposableGeometryList);
        ...
        /// The distance below which two nodes will be merged
        /// <returns>Error code</returns>
        int Mesh2dMergeNodesWithMergingDistance(int meshKernelId, DisposableGeometryList disposableGeometryList, double mergingDistance);
        ...
        /// <param name="minimumNumSamples">The minimum number of samples that must be added refinement</param>
        ...
        /// <summary>Synchronize provided mesh</summary>
        /// <param name="meshKernelId">Id of the mesh state</param>
        /// <param name="disposableMesh2D">The <seealso cref="DisposableMesh2D"/> defining the mesh2d that needs to be set.</param>
        /// <returns>Error code</returns>
        int Mesh2dSet(int meshKernelId, DisposableMesh2D disposableMesh2D);

        /// <summary>
        /// Gets the double value used the back-end library as separator and missing value
        /// </summary>
        ...
        /// The fixed chainages for each polyline. Chunks are separated by the separator, each chunk corresponds to a polyline</param>
        ...
        /// <returns>Error code</returns>
        int Network1dComputeFixedChainages(int meshKernelId, double[] fixedChainages, double minFaceSize, double fixedChainagesOffset);
        ...
        /// <returns>Error code</returns>
        int Network1dSet(int meshKernelId, DisposableGeometryList polylines);

        /// <summary>
        /// Convert network chainages to mesh1d nodes and edges
        /// </summary>
        /// <param name="meshKernelId">The meshKernelId The id of the mesh state</param>
        /// <param name="minFaceSize">
        /// The minFaceSize The minimum face size below which two nodes will be merged</param>
        /// <returns>Error code</returns>
        ...
        /// <returns>Error code</returns>
        int PolygonCountOffset(int meshKernelId, DisposableGeometryList disposableGeometryList,
        ...
        /// <summary>
        /// Selects points polygons
        /// </summary>
        /// <param name="meshKernelId">Id of the grid state</param>
        /// <param name="inputPolygon">The polygon(s) used for selection</param>
        /// <param name="inputPoints">The points to select</param>
        /// <param name="selectedPoints">The selected points the zCoordinates field (0.0 not selected, 1.0 selected)</param>
        /// <returns>Error code</returns>
        int GetPointsInPolygon(int meshKernelId,
                               DisposableGeometryList inputPolygon,
                               DisposableGeometryList inputPoints,
        ...
        /// <returns>Error code</returns>
        int PolygonEquidistantRefine(int meshKernelId, DisposableGeometryList disposableGeometryListIn, int firstIndex,
