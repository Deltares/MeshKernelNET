...
namespace MeshKernelNETTest.Api
{
        ...
        public void CurvilinearDerefineThroughAPI()
        {
            ...
            using (var api = new MeshKernelApi())
            {
                ...
                try
                {
                    ...
                    // Execute
                    Assert.That(api.CurvilinearRefine(id, 10.0, 20.0, 30.0, 20.0, -2), Is.EqualTo(0));
                    // Assert
    ...
    class CurvilinearGetNodeLocationIndexTest
    {
        ...
        public void CurvilinearFrozenLinesGetIds_ShouldReturnCorrectIds()
        {
            ...
            // Act
            int returnCode = api.CurvilinearFrozenLinesGetIds(id, out var frozenLinesIds);

            // Assert
            Assert.That(returnCode, Is.EqualTo(0));
            Assert.That(frozenLinesIds.Values[0], Is.EqualTo(frozenLineId));
        }
